...
Active baseline: Claude Code 2.1.257, captured 2026-09-01 (single pin; issue #12).
...
|---|---|---|---|---|---|
| `cc-2.1.257-sdk-cli` | `2.1.257` | `0.112.1` | `v26.3.0` | `sdk-cli` | live shared-capture mitmproxy, Opus/Sonnet/Haiku/default, 2026-09-01 |
...
Explicit Opus beta (2.1.257, same membership as 2.1.232):
...
Billing (no cch): `cc_version=2.1.257.27e; cc_entrypoint=sdk-cli;` for prompt `Say OK`.
